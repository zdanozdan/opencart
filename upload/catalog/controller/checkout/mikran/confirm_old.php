	...
	public function index() {
		...
		if (!$redirect) {
			...
			if ($this->customer->isLogged()) {
				...
				//$order_data['custom_field'] = $this->session->data['shipping_address']['custom_field'];
			}
			...
			$data['payment'] = $this->load->controller('extension/payment/' . $this->session->data['payment_method']['code'],$data['totals']);
		...
		$this->response->setOutput($this->load->view('checkout/mikran/confirm', $data));
        //return $this->load->view('checkout/mikran/confirm', $data);
	}
}
