...
class ControllerExtensionTotalCodFee extends Controller {
	...
	public function index() {
        ...
        if (isset($this->request->post['total_cod_fee_type'])) {
			$data['total_cod_fee_type'] = $this->request->post['total_cod_fee_type'];
		} else {
			$data['total_cod_fee_type'] = $this->config->get('total_cod_fee_type');
		}
		...
		if (isset($this->request->post['total_cod_fee_sort_order'])) {
			...
			$data['total_cod_fee_sort_order'] = $this->config->get('cod_sort_order');
		}
	...
	protected function validate() {
        ...
        if($this->request->post['total_cod_fee_type'] == 'P' && $this->request->post['total_cod_fee_fee'] > 100) {
